...
namespace AndroidPatientAppMaui.ViewModels.Popup
{
    public class InfoPopupPageViewModel :BaseViewModel
    {
        //TODO : To Define Local Variables Here 
        public ManageSubscriptionPageViewModel VM;
        public ManageSubscriptionPage ManagePg;
        public InfoPopupPage ObjInfoPopupPage;
        public string AppName = Preferences.Get("AppName", string.Empty);
        #region Constructor
        public InfoPopupPageViewModel(INavigation nav, InfoPopupPage infoPopupPage, ManageSubscriptionPage _managePg)
        {
            Navigation = nav;
            ObjInfoPopupPage = infoPopupPage;
            ManagePg = _managePg;
